...
local WATCHER = "butschster.tui_desktop.test.requires.watcher"
...
local function define_tests()
    test.describe("butschster.tui_desktop meta.requires", function()
        test.it("a shell is refused to a person without the right, and opens past the check for one with it", function()
            ...
            local user = boot("butschster.tui_desktop.test.requires.user", "user")
            ...
            -- not this refusal.
            local admin = boot("butschster.tui_desktop.test.requires.admin", "admin")
