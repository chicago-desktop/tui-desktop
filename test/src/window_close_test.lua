...
local function define_tests()
    test.describe("butschster.tui_desktop close requests", function()
        ...
        test.it("shutdown does not ask: a window that refuses is killed after the grace, a pending request too", function()
            local desk = boot("butschster.tui_desktop.test.close.quit")
