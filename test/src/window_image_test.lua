...
-- of butschster/windows): a folder window that navigates in place changes its
...
local function define_tests()
    test.describe("butschster.tui_desktop published title-bar picture", function()
        test.it("a published image replaces the title-bar picture; an absent or empty one keeps it", function()
            local desk = boot("butschster.tui_desktop.test.image")
